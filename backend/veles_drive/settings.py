...
MIDDLEWARE = [
    ...
    'veles_drive.middleware.AnalyticsMiddleware',
...
if DATABASE_URL:
    ...
    DATABASES = {
        'default': {
            ...
            'HOST': os.getenv('POSTGRES_HOST', 'veles-drive-postgres'),
...
DEFAULT_FROM_EMAIL = 'VELES AUTO <your-email@gmail.com>'
...
# Обновленные настройки аутентификации
...
TELEGRAM_CHANNEL_USERNAME = os.getenv('TELEGRAM_CHANNEL_USERNAME', '@veles_drive')
